...
assert_symlink "$CASE_DIR/home/AGENTS.md" "$REPO_DIR/config/agents/AGENTS.md"
assert_symlink "$CASE_DIR/home/.claude/CLAUDE.md" "$REPO_DIR/config/agents/AGENTS.md"
assert_symlink "$CASE_DIR/home/.codex/AGENTS.md" "$REPO_DIR/config/agents/AGENTS.md"
assert_symlink "$CASE_DIR/home/.claude/skills/agentflow" "$REPO_DIR/config/skills/agentflow"
